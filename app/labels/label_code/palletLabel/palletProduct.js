function emptyPalletProductData(location) {
  let product_data = `
...
function blankPalletProductData(pallet, location) {
  let product_data = `
^FO${location - 30},10^GB160,1170,5^FS
^FO${location + 50},10^GB5,1170,5^FS
^FO${location + 70},50^A0,37^FD
${pallet.product_description.toUpperCase()}
^FS
^FO${location},20^A0,40^FDLOT:^FS
